...
func (bm *BackupMergeHandler) uploadMergedBackupToStorage(tempDir string, workers *BackupWorkers, uploader *internal.RegularUploader) (*internal.TarFileSets, *Bundle) {
